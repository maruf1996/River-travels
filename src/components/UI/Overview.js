        ...
        <div className="divide-y divide-gray-700">
          <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
            ...
            <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
              ...
              <span className="uppercase text-xl font-bold md:text-2xl">
                Select DEC / SINGLE CABIN / VIP CABIN
              </span>
              <span className="mt-4 dark:text-gray-300">
                Select your preferred service, suppose dec, single cabin, vip
                cabin room by viewing the visual layout and smothly rivers
                journy
              </span>
            </div>
          </div>
          <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
            ...
            <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
              ...
              <span className="text-xl font-bold md:text-2xl uppercase">
                Make sure sign in or sign up
              </span>
              <span className="mt-4 dark:text-gray-300">
                I recomended you please make sure you sign in or sign up, sign
                in or sign up River Travels via website, android or IOS app
              </span>
            </div>
          </div>
          <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
            ...
            <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
              <span className="text-xs tracki uppercase dark:text-violet-400">
                Step 3 - Select Date/Time and Seat/ Room
              </span>
              <span className="text-xl font-bold md:text-2xl uppercase">
                Make Sure Select Date/Time and Seat/ Room
              </span>
              <span className="mt-4 dark:bg-gray-800 dark:text-gray-300">
                Select your preferred date/time and seat/ room by viewing the
                visual layout booking ticket page, I hopefully this is Your
                happy journy
              </span>
            </div>
          </div>
          <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
            ...
            <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
              ...
              <span className="mt-4 dark:bg-gray-800 dark:text-gray-300">
                Complete your payment through secure payment gateway
              </span>
            </div>
          </div>
        </div>
